<?php
        ...
        if(is_array($result)){
         ...
         if(!$refresh){
                $messages ="
                <div id='messages_holder_parent' onclick=' set_seen(event)' style='height:480px;'>
        
                <div id='messages_holder' style='height:400px;overflow-y:scroll;'>";
         }
            ...
            $mydata ="Previous Chats:<br>";
                if(is_array($result2)){
                        ...
                        foreach($result2 as $data){
                                ...
                                $image=( $myuser->gender=="Male") ?"Images/man_4140048.png" : "Images/woman_4140047.png" ;
